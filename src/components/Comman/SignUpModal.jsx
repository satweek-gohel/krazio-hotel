...
const SignUpModal = ({ isOpen, onClose, onLoginClick }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      setLoading(true);
      const response = await fetch('https://sandbox.vovpos.com:3002/web/signup', {
        method: 'POST',
        headers: {
  ...
  const handleVerifyOTP = async (otp) => {
    try {
      const response = await fetch('http://sandbox.vovpos.com:3002/web/verify-otp', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      {isOpen && (
        <>
          ...
          <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full max-w-md bg-white rounded-lg p-6 z-50 max-h-[90vh] overflow-auto">
            ...
            <h2 className="text-2xl font-semibold mb-8 text-gray-800">Sign Up</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  />
                  {firstSubmitAttempt && !formData.first_name && <p className="text-red-500 text-xs mt-1">First name is required</p>}
                </div>
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none text-gray-900 placeholder:text-gray-400"
                  />
                  {firstSubmitAttempt && !formData.last_name && <p className="text-red-500 text-xs mt-1">Last name is required</p>}
                </div>
              </div>
              ...
              <div className="space-y-1.5">
                ...
                />
                {firstSubmitAttempt && !formData.mobile_number && <p className="text-red-500 text-xs mt-1">Mobile number is required</p>}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-red-500 focus:border-transparent outline-none text-gray-900 placeholder:text-gray-400"
                />
                {firstSubmitAttempt && !formData.email_address && <p className="text-red-500 text-xs mt-1">Email address is required</p>}
                {firstSubmitAttempt && formData.email_address && !validateEmail(formData.email_address) && <p className="text-red-500 text-xs mt-1">Invalid email address</p>}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                />
                {firstSubmitAttempt && !formData.date_of_birth && <p className="text-red-500 text-xs mt-1">Date of birth is required</p>}
              </div>
              ...
              <div className="space-y-1.5">
                ...
                {firstSubmitAttempt && !formData.gender && <p className="text-red-500 text-xs mt-1">Gender is required</p>}
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="space-y-1.5">
                  ...
                  {firstSubmitAttempt && !formData.password && <p className="text-red-500 text-xs mt-1">Password is required</p>}
                </div>
                <div className="space-y-1.5">
                  ...
                  {firstSubmitAttempt && formData.password && formData.password !== confirmPassword && <p className="text-red-500 text-xs mt-1">Passwords do not match</p>}
                </div>
              </div>
              ...
              <div className="flex items-start">
                ...
                {firstSubmitAttempt && !agreeToTerms && <p className="text-red-500 text-xs mt-1">You must agree to the terms</p>}
              </div>
